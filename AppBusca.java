...
public class AppBusca {
    ...
    static Produto[] produtosOrdenados;
    ...
    static void ordenarProdutos() {
        ...
        produtosOrdenados = mergesort.ordenar(produtos, Produto::compareTo);
    ...
    static void fazerBuscaBinaria() {
        IBuscador<Produto> buscador = new BuscaBinaria<>(produtosOrdenados, Produto::compareTo);
        Produto prod = localizarProduto(buscador);
        resultadoBusca(prod, buscador);
    }
